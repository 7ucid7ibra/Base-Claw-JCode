...
from speech import normalize_speech_url
from ui.speech_panel import (
    install_local_speech_host,
    local_speech_state,
    local_speech_urls,
    speech_health,
    start_local_speech_host,
    stop_local_speech_host,
)
...
class OperatorUi(ctk.CTk):
    ...
    def _run_desktop_agent_turn(self, text: str, values: dict[str, str]) -> None:
        try:
            ...
            cmd, stdin_text = build_desktop_agent_command(
                provider,
                prompt,
                session_id,
                values,
