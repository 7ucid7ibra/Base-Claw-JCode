...
$script = Join-Path $projectRoot "app\telegram_operator.py"
...
$logPath = Join-Path $profileDir "telegram_operator.supervisor.log"
...
while ($true) {
    ...
    Add-Content -Path $logPath -Value "$ts starting telegram_operator.py"
